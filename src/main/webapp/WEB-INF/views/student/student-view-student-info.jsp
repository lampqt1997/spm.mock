						...
						<div class="left-body mt-2">
							<div class="form-group  pl-5">
								...
								<p class="h3 text-dark text-uppercase">Thông tin chi tiết</p>
									<div class="col-12">
										<div class="float-left col-7 pl-0">
											<div class="float-left mr-4">
												<img src="https://via.placeholder.com/120" class="rounded"
													alt="...">
											</div>

											<div class="float-left offset-1mt-3">
												...
												<p class="h6 text-dark font-weight-bold">6. Công nghệ</p>
												<c:forEach items="${student.getStechnologies().split('-') }" var="e">
