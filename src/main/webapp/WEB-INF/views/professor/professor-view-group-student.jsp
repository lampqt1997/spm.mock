								...
								<div class="card-header" id="headingThree">
									...
									<h2 class="mb-0">
										<button class="btn btn-link text-dark collapsed" type="button"
											...
											Chi tiết Nhóm sinh viên</button>
												...
												<c:forEach items="${students}" var="item">
													<tr>
														<td>
														 ...
														 <td>
															 <a href="<c:url value="/handler/pr-view-student-info/${item.getId()}" />" class="btn btn-link text-info"> 
															 ${item.getName()}
																		
															</a>
														</td> 
														<td>
															<c:out value="${item.getStudentCode()}"></c:out>
														</td>
														<td>
															<c:out value="${item.getGrade()}"></c:out>
														</td>
													</tr>
